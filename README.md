...
เนื้อหาและข้อความในตารางใช้ Align Left ไม่ใช้ Distributed หรือ Thai Distributed ตั้ง Character Spacing เป็น Normal, Scale 100%, Spacing 0 pt และ Position Normal หัวข้อและคำบรรยายภาพคงการจัดแนวตามแม่แบบ
